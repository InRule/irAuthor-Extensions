...
## Installation
1. Download the installation package from [here](https://github.com/InRule/irAuthor-Extensions/releases/).  If needed, right-click on the download file, go to "Properties", and tick the box to "Un-block" the downloaded file.
